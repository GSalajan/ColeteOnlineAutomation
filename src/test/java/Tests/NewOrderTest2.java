...
public class NewOrderTest2 extends Hooks
{
    @Test
    public void NewOrderTest2()
    {
        LoginPage loginPage = new LoginPage(getDriver(), getWaitDriver(), "TestData/LoginWithEmailTestResource");
        NewOrderPage newOrderPage = new NewOrderPage(getDriver(), getWaitDriver(), "TestData/NewOrderTest2Resource");
